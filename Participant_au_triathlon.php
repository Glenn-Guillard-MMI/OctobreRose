...
<head>
    ...
    <link rel="stylesheet" href="triathlon.css?iohhdsssdqqdio" />
...
<body>
    ...
    <main>
        ...
        <section class="art">
            <article>
                <iframe src="https://www.youtube.com/embed/yAY-fQHle8A" title="How to bring a basket into the classroom"
                    frameborder="0"
        ...
        <div id="menu">
            <article>
                ...
                <a href="aaaaa.html"><button>Consulter</button></a>
            </article>
        </div>
    </main>
